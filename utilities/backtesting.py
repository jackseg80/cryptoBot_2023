...
def basic_single_asset_backtest(trades, days):
    ...
    print(" ⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯")
    print("| Période".ljust(30), "| {} -> {}".format(*[d.strftime("%Y-%m-%d") for d in [df_days.iloc[0]["day"], df_days.iloc[-1]["day"]]]).ljust(30), "|")
    print("| Portefeuille initial".ljust(30), "| {:,.2f} $".format(initial_wallet).ljust(30), "|")
    print(" ⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯")
    print("| Portefeuille final".ljust(30), "| {:,.2f} $".format(final_wallet).ljust(30), "|")
    print("| Performance vs US dollar".ljust(30), "| {:,.2f} %".format(vs_usd_pct*100).ljust(30), "|")
    print("| Pire Drawdown T|D".ljust(30), "| -{}% | -{}%".format(round(max_trades_drawdown*100, 2), round(max_days_drawdown*100, 2)).ljust(30), "|")
    print("| Buy and hold performance".ljust(30), "| {} %".format(round(buy_and_hold_pct*100,2)).ljust(30), "|")
    print("| Performance vs buy and hold".ljust(30), "| {:,.2f} %".format(vs_hold_pct*100).ljust(30), "|")
    print("| Nombre total de trades".ljust(30), "| {}".format(total_trades).ljust(30), "|")
    print("| Sharpe Ratio".ljust(30), "| {}".format(round(sharpe_ratio,2)).ljust(30), "|")
    print("| Global Win rate".ljust(30), "| {} %".format(round(global_win_rate*100, 2)).ljust(30), "|")
    print("| Profit moyen".ljust(30), "| {} %".format(round(avg_profit*100, 2)).ljust(30), "|")
    print("| Total des frais".ljust(30), "| {:,.2f} $".format(total_fees).ljust(30), "|")
    print(" ⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯")
